...
Проект в постоянной переработке, постоянно меняются методы, реализация законов, визуализация. Изначально проект вообще был целиком написан нейросеткой, но я почти полностью ушел от "вайбов" (считаю что начинать с этого - убивать мозг) и пользуюсь только советами.
